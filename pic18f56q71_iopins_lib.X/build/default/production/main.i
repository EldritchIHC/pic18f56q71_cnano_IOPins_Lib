...
# 42 "./IOPINS.h"
   ...
   void IOPINS_vPortInterruptConfig(uint8_t u8Port, uint8_t u8PinMask, _Bool bEdge , _Bool bInterruptMethod);
   ...
   _Bool IOPINS_bPinBInterruptRead(uint8_t u8PinMask);
   ...
   _Bool IOPINS_bPinCInterruptRead(uint8_t u8PinMask);
...
void main(void) {
    ...
    uint8_t u8MaskPortA1 = 0;
    uint8_t u8MaskPortB1 = 0;
    uint8_t u8MaskPortD1 = 0;

    uint8_t u8PinList1[] = {7};
    uint8_t u8PinList2[] = {0, 1};

    uint8_t u8PinListPortA1[] = {6, 7 };
    uint8_t u8PinListPortB1[] = {4, 5 };
    uint8_t u8PinListPortD1[] = {0, 1, 4, 5 };
    uint8_t u8PinListPortA2[] = {1};
    ...
    IOPINS_vPortConfig(0, u8Mask2, 1, 1, 1);

    IOPINS_vPortInterruptConfig(0, u8Mask2, 0, 1);
    IOPINS_vPortConfig(2, u8Mask1, 0, 0, 1);
    IOPINS_vPortConfig(0, u8MaskPortA1, 0, 0, 1);
    IOPINS_vPortConfig(1, u8MaskPortB1, 0, 0, 1);
    IOPINS_vPortConfig(3, u8MaskPortD1, 0, 0, 1);
...
void __attribute__((picinterrupt(("irq(7),base(8)")))) IOC0_ISR()
{
    PIR0bits.IOCIF = 0;
    if(IOCAFbits.IOCAF0)
    {
